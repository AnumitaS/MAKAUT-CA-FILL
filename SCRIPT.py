...
# 3. Dynamic Output Directory Creation Outside the Input Folder
input_file_path = Path(DATA_FILE_PATH).resolve()
parent_department_folder = input_file_path.parent.parent  # Moves out of 'input' into department folder

OUTPUT_DIR_DOCX = os.path.join(parent_department_folder, "out", "doc")
OUTPUT_DIR_PDF = os.path.join(parent_department_folder, "out", "pdf")
...
try:
    ...
    for idx, row in df.iterrows():
        ...
        # Matched specifically to 'Student name' and 'Roll' from your file
        ...
        # Matched specifically to 'Student sign'
        ...
        clean_subj = clean_filename_str(common_data.get("Subject", "Subject"))
        
        output_base_name = f"{clean_name}_{clean_roll}_{clean_subj}"
